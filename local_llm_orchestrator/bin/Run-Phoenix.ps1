...
$Job = Start-Process phoenix -ArgumentList "serve", "--port", $env:PHOENIX_PORT -NoNewWindow -PassThru -RedirectStandardOutput "$LogDir\phoenix.log" -RedirectStandardError "$LogDir\phoenix_errors.log"
